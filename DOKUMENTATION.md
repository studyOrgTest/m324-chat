...
| Monitoring | Uptime Kuma mit E-Mail-Benachrichtigung |
...
flowchart TD
    ...
    MON -->|"nicht erreichbar"| MAIL["E-Mail-Benachrichtigung"]
```
...
per E-Mail, sobald die Applikation nicht mehr erreichbar ist. Uptime Kuma wird lokal über
`docker-compose.monitoring.yml` gestartet:
...
### 4.2 E-Mail-Benachrichtigung (Notifier)

Als Benachrichtigungskanal wird ein **E-Mail-Notifier (SMTP)** konfiguriert. Er wird dem
Monitor zugewiesen und löst aus, sobald der Monitor den Status «Down» meldet.

| Einstellung | Wert |
|---|---|
| Notification-Typ | Email (SMTP) |
| SMTP-Host | z. B. `smtp.gmail.com` |
| Port | 587 (STARTTLS) |
| Benutzername / Passwort | SMTP-Zugangsdaten bzw. App-Passwort |
| Von / An | Absender- und Empfänger-Adresse |

![Uptime Kuma – E-Mail-Notifier](docs/screenshots/uptime-kuma-notification.png)
